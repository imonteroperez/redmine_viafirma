...
require 'redmine'
require 'viafirma/account_controller_patch'

Redmine::Plugin.register :redmine_viafirma do
  name 'Redmine Viafirma Plugin'
  author 'Ildefonso Montero'
  description 'Authentication plugin for Viafirma'
  version '1.0.0-beta'
